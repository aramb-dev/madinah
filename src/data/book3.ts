  ...
  lessons: [
    {
      ...
      rules: [
        ...
        },
        {
          ...
          explanation:
            "The past tense verb and the imperative verb are always indeclinable. ",
        },
        {
      ...
      rules: [
        {
          ...
          explanation:
            "Introduces a circumstantial clause, which is in the accusative state. ",
        },
        {
        ...
        },
        {
          ...
          explanation:
            'An imperative verb-like noun meaning "Take" or "Here you are". ',
        },
        {
        ...
        },
        {
          ...
          explanation:
            "These patterns are diptotes (prevented from tanween and kasra). ",
        },
      ],
    },
    {
      ...
      rules: [
        {
          ...
          explanation:
            "A nominative noun that replaces the subject in a passive sentence. ",
        },
        {
          ...
          explanation:
            "Formed by adding ـِيٌّ to a noun to create an adjective of attribution. ",
        },
        {
          ...
          explanation:
            "A particle used for detailing, doubt, choice, permission, or vagueness. ",
        },
        {
      ...
      rules: [
        {
          ...
          explanation:
            "Starts with a noun, an interpreted verbal noun, or إِنَّ and its sisters. ",
        },
        {
    ...
    },
    {
      ...
      rules: [
        ...
        },
        {
          ...
          explanation:
            "The predicate must agree with the subject in number and gender. ",
        },
      ],
    },
    {
      ...
      rules: [
        {
          ...
          explanation:
            'An accusative noun that implies the meaning of "in" (فِي). ',
        },
        {
    ...
    },
    {
      ...
      rules: [
        ...
        },
        {
          ...
          explanation:
            "A vocative style used for mourning, using the particle وَا. ",
        },
      ],
    },
    {
      ...
      rules: [
        {
          ...
          explanation:
            "A verb whose effect passes to an object. It can accept the suffix ـهُ. ",
        },
        {
