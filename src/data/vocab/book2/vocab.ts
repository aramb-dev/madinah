/**
 * @file Local vocabulary schema for Book 2
 * @description Type definitions used by the legacy Book 2 vocabulary data files.
 * Kept local to the book2 directory so the data is type-checked without
