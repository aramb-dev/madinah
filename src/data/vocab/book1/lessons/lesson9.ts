...
export const lesson9 = {
  ...
  items: [
    ...
    },
    {
      ...
      examples: [
        {
          arabic: "الْعُصْفُورُ عَلَى الشَّجَرَةِ.",
          english: "The sparrow is on the tree.",
        },
    ...
    },
    {
      ...
      examples: [
        ...
        {
          arabic: "الطَّائِرُ يَطِيرُ فِي السَّمَاءِ.",
    ...
    },
    {
      ...
      examples: [
        {
          arabic: "اللُّغَةُ الْعَرَبِيَّةُ سَهْلَةٌ.",
          english: "The Arabic language is easy.",
        },
