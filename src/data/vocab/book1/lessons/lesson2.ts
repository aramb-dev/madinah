...
export const lesson2 = {
  ...
  items: [
    ...
    },
    {
      ...
      examples: [
        {
          arabic: "مَا ذَلِكَ؟ ذَلِكَ قَمَرٌ.",
          english: "What is that? That is a moon.",
        },
        {
          arabic: "مَا ذَلِكَ؟ ذَلِكَ مِفْتَاحٌ.",
          english: "What is that? That is a key.",
        },
      ],
      difficulty: vocab.DifficultyLevel.Beginner,
      tags: ["lesson2"],
    },
    {
      ...
      examples: [
        {
          arabic: "أَذَلِكَ كَلْبٌ؟ لَا، ذَلِكَ قِطٌّ.",
          english: "Is that a dog? No, that is a cat.",
        },
        {
          arabic: "أَذَلِكَ قَمِيصٌ؟ نَعَمْ، ذَلِكَ قَمِيصٌ.",
          english: "Is that a shirt? Yes, that is a shirt.",
        },
      ],
      difficulty: vocab.DifficultyLevel.Beginner,
      tags: ["lesson2"],
