  ...
  items: [
    {
      ...
      examples: [
        {
          arabic: "الْمَسْجِدُ خَلْفَ الْبَيْتِ.",
          english: "The masjid is behind the house.",
        },
    ...
    },
    {
      ...
      examples: [
        {
          arabic: "السَّيَّارَةُ أَمَامَ الْبَيْتِ.",
          english: "The car is in front of the house.",
        },
        {
          arabic: "الْمُدَرِّسُ أَمَامَ السَّبُّورَةِ.",
          english: "The teacher is in front of the board.",
        },
      ],
      difficulty: vocab.DifficultyLevel.Beginner,
      tags: ["lesson8"],
    },
    {
      ...
      examples: [
        ...
        {
          arabic: "السِّكِّينُ عَلَى الطَّاوِلَةِ.",
