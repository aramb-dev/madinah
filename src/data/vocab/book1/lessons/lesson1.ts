...
export const lesson1 = {
  ...
  description: {
    ar: 'الكلمات الجديدة في الدرس الأول.',
    en: 'New words in the first lesson.',
  },
  bookId: 'book1',
  lessonId: '1',
  ...
  items: [
    {
      ...
      examples: [
        ...
        { arabic: 'هَذَا مَسْجِدٌ.', english: 'This is a masjid.' },
    ...
    },
    {
      ...
      plural: 'مَسَاجِدُ',
      examples: [
        { arabic: 'الْمَسْجِدُ قَرِيبٌ.', english: 'The masjid is nearby.' },
        { arabic: 'أَيْنَ الْمَسْجِدُ؟', english: 'Where is the masjid?' },
      ],
      difficulty: vocab.DifficultyLevel.Beginner,
      tags: ['lesson1'],
    },
