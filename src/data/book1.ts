  ...
  lessons: [
    {
      ...
      rules: [
        ...
        },
        {
          ...
          explanation:
            "Is an interrogative pronoun used for non-rational nouns.",
        },
        {
          name: "أَ (a - ?)",
    ...
    },
    {
      ...
      rules: [
        ...
        },
        {
          ...
          explanation:
            "When (ال) enters a noun, the tanween (nunation) is removed.",
        },
        {
          name: "النَّكِرَةُ (al-nakirah - indefinite)",
          arabicText: "النَّكِرَةُ: شَيْءٌ غَيْرُ مُعَيَّنٍ، نَحْوُ: بَيْتٌ، قَلَمٌ، رَجُلٌ، بِنْتٌ.",
          explanation:
        ...
        },
        {
          ...
          arabicText: "الْمَعْرِفَةُ: شَيْءٌ مُعَيَّنٌ، نَحْوُ: الْبَيْتُ، الْقَلَمُ، الرَّجُلُ، الْبِنْتُ.",
          explanation:
        ...
        },
        {
          ...
          explanation:
            "The sukoon on the lām (ل) is pronounced (e.g., الْقَمَرُ - al-qamar).",
        },
        {
    ...
    },
    {
      ...
      rules: [
        ...
        },
        {
          ...
          explanation:
            "Is equivalent to مَا هَذَا؟ (mā hādhā?) for non-rational things.",
        },
        {
          name: "اَلْعَلَمُ الْمُؤَنَّثُ لَا يُنَوَّنُ (Feminine proper nouns do not take tanween)",
          arabicText: "اَلْعَلَمُ الْمُؤَنَّثُ لَا يُنَوَّنُ (نَحْوُ: آمِنَةُ، فَاطِمَةُ، مَرْيَمُ، عَائِشَةُ).",
          explanation:
    ...
    },
    {
      ...
      rules: [
        ...
        },
        {
          ...
          arabicText: "لِمَنْ؟ سُؤَالٌ عَنِ الْعَاقِلِ. لِمَنْ هَذَا الْبَيْتُ؟ هَذَا الْبَيْتُ لِلتَّاجِرِ.",
          explanation:
    ...
    },
    {
      ...
      rules: [
        ...
        },
        {
          ...
          arabicText: "الَّذِي: اسْمٌ مَوْصُولٌ لِلْمُفْرَدِ الْمُذَكَّرِ الْعَاقِلِ، وَغَيْرِ الْعَاقِلِ.",
          explanation:
    ...
    },
    {
      ...
      rules: [
        ...
        },
        {
          ...
          arabicText: "عِنْدِي: لِغَيْرِ الْعَاقِلِ (عِنْدِي كِتَابٌ). لِي: لِلْعَاقِلِ (لِي أُخْتٌ).",
          explanation:
        ...
        },
        {
          ...
          explanation:
            "Is an adverb of place. The noun following it is genitive (muḍāf ilayhi).",
        },
        {
      ...
      rules: [
        {
          ...
          arabicText: "ضَمِيرُ الْغَائِبِ الْمُذَكَّرِ: فِيهِ. ضَمِيرُ الْغَائِبِ الْمُؤَنَّثِ: فِيهَا.",
          explanation:
            "Masculine: فِيهِ (fīhi - in it/him). Feminine: فِيهَا (fīhā - in it/her).",
        },
        {
      ...
      rules: [
        {
          ...
          arabicText: "هَؤُلَاءِ: اِسْمُ إِشَارَةٍ لِلْجَمْعِ الْقَرِيبِ الْعَاقِلِ الْمُذَكَّرِ، وَالْمُؤَنَّثِ.",
          explanation:
        ...
        },
        {
          ...
          arabicText: "أُولَئِكَ: اسْمُ إِشَارَةٍ لِلْجَمْعِ الْبَعِيدِ الْعَاقِلِ الْمُذَكَّرِ، وَالْمُؤَنَّثِ.",
          explanation:
    ...
    },
    {
      ...
      rules: [
        ...
        },
        {
          ...
          arabicText: "قَبْلَ، وَبَعْدَ: ظَرْفَانِ لِلزَّمَانِ، وَالِاسْمُ الَّذِي بَعْدَهُمَا مُضَافٌ إِلَيْهِ.",
          explanation:
            "Are adverbs of time. The noun following them is muḍāf ilayhi.",
        },
      ],
    },
    {
      ...
      rules: [
        {
          ...
          arabicText: "الْمُثَنَّى: مَا دَلَّ عَلَى اثْنَيْنِ، أَوِ اثْنَتَيْنِ لِلْعَاقِلِ، وَغَيْرِ الْعَاقِلِ.",
          explanation:
            "Indicates two, masculine or feminine, rational or irrational.",
        },
        {
          ...
          explanation:
            "هَذَانِ for near dual masculine. هَاتَانِ for near dual feminine.",
        },
        {
    ...
    },
    {
      ...
      rules: [
        ...
        },
        {
          ...
          explanation:
            "e.g., It has two big windows. The two students are hardworking.",
        },
        {
        ...
        },
        {
          ...
          explanation:
            "e.g., In the school are classrooms. They are from different countries.",
        },
      ],
    },
    {
