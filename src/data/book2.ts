  ...
  lessons: [
    {
      ...
      rules: [
        ...
        {
          name: "أَمْ (am - or)",
          arabicText: "أَمْ: حَرْفُ عَطْفٍ يَأْتِي مَعَ هَمْزَةِ التَّعْيِينِ. أَمُجْتَهِدٌ أَنْتَ أَمْ كَسْلَانُ؟",
          explanation:
    ...
    },
    {
      ...
      rules: [
        ...
        },
        {
          ...
          arabicText: "حَرْفٌ يَدُلُّ عَلَى أَنَّ مَا بَعْدَهُ مُؤَنَّثٌ. غَسَلَتْ آمِنَةُ الثَّوْبَ.",
          explanation:
    ...
    },
    {
      ...
      rules: [
        ...
        },
        {
          ...
          explanation:
            "The initial hamzah of a triliteral imperative verb is hamzat al-waṣl (ٱ).",
        },
        {
    ...
    },
    {
      ...
      rules: [
        ...
        },
        {
          ...
          explanation:
            'Review of the pattern مَا أَفْعَلَهُ! (e.g., "How tall Hamid is!").',
        },
      ],
    },
    {
    ...
    },
    {
      ...
      rules: [
        ...
        },
        {
          ...
          arabicText: "حَرْفٌ يَنْصِبُ الْفِعْلَ الْمُضَارِعَ، وَيَجْعَلُهُ لِلْمُسْتَقْبَلِ. أُرِيدُ أَنْ أَسْأَلَكَ.",
          explanation:
    ...
    },
    {
      ...
      rules: [
        ...
        },
        {
          ...
          arabicText: "أَصْلُهَا: أَنْ + لَا النَّافِيَةُ. أَرْجُو أَنْ تَدْخُلَ -> أَرْجُو أَلَّا تَدْخُلَ.",
          explanation:
        ...
        },
        {
          ...
          arabicText: "حَرْفُ جَرٍّ يُفِيدُ التَّشْبِيهَ. هَذِهِ الْمَدْرَسَةُ كَالْمَسْجِدِ. أَنْتَ كَالْأَسَدِ.",
          explanation:
    ...
    },
    {
      ...
      rules: [
        ...
        },
        {
          ...
          arabicText: "فِعْلَانِ مَاضِيَانِ أَجْوَفَانِ. اسْمُ التَّفْضِيلِ مِنْهُمَا: أَطْيَبُ، أَلْيَنُ.",
          explanation:
    ...
    },
    {
      ...
      rules: [
        ...
        },
        {
          ...
          arabicText: "الْمُضَارِعُ الْمُسْنَدُ إِلَى أَلِفِ الِاثْنَيْنِ فِعْلٌ مِنَ الْأَفْعَالِ الْخَمْسَةِ.",
          explanation:
