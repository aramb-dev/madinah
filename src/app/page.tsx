      ...
      <div className="space-y-6">
        <Card className="border-emerald-100 shadow-md">
          <CardHeader className="pb-2">
            <CardTitle className="text-xl font-semibold text-emerald-700 font-arabic">
              مرحباً بك!
            </CardTitle>
          </CardHeader>
          <CardContent>
            <p className="arabic-text font-arabic text-neutral-700 mb-4">
              أهلاً بك في تطبيق قواعد اللغة العربية التفاعلية. اختر درساً من القائمة الجانبية للبدء،
              أو اختر من القائمة أدناه.
            </p>
            <p className="english-text text-neutral-600 mb-6">
              Welcome to the Interactive Arabic Grammar Rules application. Choose a lesson from the
              sidebar to begin, or select from the list below.
            </p>
