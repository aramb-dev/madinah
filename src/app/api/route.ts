...
export function GET() {
  const apiDocumentation = {
    ...
    version: "1.0.0",
    description:
      "Public API for accessing Madinah Arabic learning books and lessons data",
    baseUrl: "/api",
    endpoints: {
      books: {
        "GET /api/books": {
      ...
      vocabulary: {
        "GET /api/vocabulary": {
          description:
            "Get all vocabulary from all books, with optional filters.",
          parameters: {
        ...
        "GET /api/books/{bookId}/lessons/{lessonId}/vocabulary": {
          description:
            "Get all vocabulary for a specific lesson in a specific book",
          parameters: {
            bookId: "string (book1, book2, book3)",
            lessonId: "string (lesson1, lesson2, etc.)",
          },
